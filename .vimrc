" Automatically load or install vim-plug
...
" Gruvbox Material colour scheme
Plug 'morhetz/gruvbox'

" Elegant simple status line
...
" CoC.nvim release branch (recommended)
...
" ---------------------
let g:indentLine_char = '┊' " unicode character 250A
...
augroup rainbows
  autocmd!
  autocmd FileType lisp,clojure,scheme,json,lua,r,c,cpp,python,nix,scala RainbowParentheses
augroup END
